...
## [2.3.2] - 2026-09-14
### Added
- **Turn Sanitization Guard:** Added guard in `core/translator.py` that automatically pops trailing assistant/model turns in incoming conversation payloads, preventing HTTP 400 `Requests ending with a model turn are not supported` during interrupted tool calls or subagent handoffs.
